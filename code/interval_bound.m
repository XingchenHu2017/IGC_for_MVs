function [aOptimal, bOptimal,opti_cov,opti_spe] = interval_bound(center,data)
% Optimization function for the principle of justifiable granularity
...
opti_cov = (aOpti_cov*PA+bOpti_cov*PB)/(PA+PB);
if isempty(opti_cov)
    opti_cov = 0;
end
